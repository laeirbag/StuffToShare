...
PHP_FUNCTION(printer_write)
{
	...
	if( sd && sp ) {
		WritePrinter(resource->handle, Z_STRVAL_P(arg2), Z_STRLEN_P(arg2), &recieved);
...
PHP_FUNCTION(printer_list)
{
	...
	EnumPrinters(Z_LVAL_P(arg1), Name, Level, (LPBYTE)InfoBuffer, sizeof(InfoBuffer), &bNeeded, &cReturned);
...
PHP_FUNCTION(printer_start_doc)
{
	...
	if(argc == 2) {
		...
		resource->info.lpszDocName = estrdup(Z_STRVAL_P(parameter[1]));
		resource->info.cbSize	   = sizeof(resource->info);
	}
...
PHP_FUNCTION(printer_create_pen)
{
	...
	pen = CreatePen(Z_LVAL_P(arg1), Z_LVAL_P(arg2), hex_to_rgb(Z_STRVAL_P(arg3)));
...
PHP_FUNCTION(printer_create_brush)
{
	...
	switch(Z_LVAL_P(arg1)) {
		case BRUSH_SOLID:
			brush = CreateSolidBrush(hex_to_rgb(Z_STRVAL_P(arg2)));
			break;
		case BRUSH_CUSTOM:
			virtual_filepath(Z_STRVAL_P(arg2), &path TSRMLS_CC);
			bmp = LoadImage(0, path, IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);
			brush = CreatePatternBrush(bmp);
			break;
		default:
			brush = CreateHatchBrush(Z_LVAL_P(arg1), hex_to_rgb(Z_STRVAL_P(arg2)));
	}
...
PHP_FUNCTION(printer_create_font)
{
	...
	convert_to_string_ex(arg1);
	face = estrndup(Z_STRVAL_P(arg1), 32);
	convert_to_long_ex(arg2);
	convert_to_long_ex(arg3);
	...
	font = CreateFont(Z_LVAL_P(arg2), Z_LVAL_P(arg3), Z_LVAL_P(arg8), Z_LVAL_P(arg8), Z_LVAL_P(arg4), Z_DVAL_P(arg5), Z_DVAL_P(arg6), Z_DVAL_P(arg7), DEFAULT_CHARSET, OUT_DEFAULT_PRECIS, CLIP_DEFAULT_PRECIS, ANTIALIASED_QUALITY, DEFAULT_PITCH | FF_ROMAN, face);
	efree(face);
...
PHP_FUNCTION(printer_logical_fontheight)
{
	...
	RETURN_LONG(MulDiv(Z_LVAL_P(arg2), GetDeviceCaps(resource->dc, LOGPIXELSY), 72));
}
/* }}} */
...
PHP_FUNCTION(printer_draw_roundrect)
{
	...
	RoundRect(resource->dc, Z_LVAL_P(arg2), Z_LVAL_P(arg3), Z_LVAL_P(arg4), Z_LVAL_P(arg5), Z_LVAL_P(arg6), Z_LVAL_P(arg7));
}
/* }}} */
...
PHP_FUNCTION(printer_draw_rectangle)
{
	...
	Rectangle(resource->dc, Z_LVAL_P(arg2), Z_LVAL_P(arg3), Z_LVAL_P(arg4), Z_LVAL_P(arg5));
}
/* }}} */
...
PHP_FUNCTION(printer_draw_elipse)
{
	...
	Ellipse(resource->dc, Z_LVAL_P(arg2), Z_LVAL_P(arg3), Z_LVAL_P(arg4), Z_LVAL_P(arg5));
}
/* }}} */
...
PHP_FUNCTION(printer_draw_text)
{
	...
	ExtTextOut(resource->dc, Z_LVAL_P(arg3), Z_LVAL_P(arg4), ETO_OPAQUE, NULL, Z_STRVAL_P(arg2), Z_STRLEN_P(arg2), NULL);
}
/* }}} */
...
PHP_FUNCTION(printer_draw_line)
{
	...
	MoveToEx(resource->dc, Z_LVAL_P(arg2), Z_LVAL_P(arg3), NULL);
	LineTo(resource->dc, Z_LVAL_P(arg4), Z_LVAL_P(arg5));
}
/* }}} */
...
PHP_FUNCTION(printer_draw_chord)
{
	...
	Chord(resource->dc, Z_LVAL_P(arg2), Z_LVAL_P(arg3), Z_LVAL_P(arg4), Z_LVAL_P(arg5), Z_LVAL_P(arg6), Z_LVAL_P(arg7), Z_LVAL_P(arg8), Z_LVAL_P(arg9));
}
/* }}} */
...
PHP_FUNCTION(printer_draw_pie)
{
	...
	Pie(resource->dc, Z_LVAL_P(arg2), Z_LVAL_P(arg3), Z_LVAL_P(arg4), Z_LVAL_P(arg5), Z_LVAL_P(arg6), Z_LVAL_P(arg7), Z_LVAL_P(arg8), Z_LVAL_P(arg9));
}
/* }}} */
...
PHP_FUNCTION(printer_draw_bmp)
{
	...
	if (hbmp == NULL) {
		php_error_docref(NULL TSRMLS_CC, E_WARNING, "Failed to load bitmap %s", Z_STRVAL_P(arg2));
		RETURN_FALSE;
	}
	...
	if (args > 4) {
		if (!StretchBlt(resource->dc,(int)Z_LVAL_P(arg3), (int)Z_LVAL_P(arg4), (int)Z_LVAL_P(arg5), (int)Z_LVAL_P(arg6), dummy, 0, 0, bmp_property.bmWidth,bmp_property.bmHeight, SRCCOPY)) {
		...
		if (!BitBlt(resource->dc, Z_LVAL_P(arg3), Z_LVAL_P(arg4), bmp_property.bmWidth, bmp_property.bmHeight, dummy, 0, 0, SRCCOPY)) {
			php_error_docref(NULL TSRMLS_CC, E_WARNING, "Printer failed to accept bitmap");
			DeleteDC(dummy);
			DeleteObject(hbmp);
			RETURN_FALSE;
